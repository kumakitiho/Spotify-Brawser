...
const configContent = [
    ...
    '        { href: "turntable-reference-match.css?v=20260705-reference-match-v4", key: "turntable-reference-match" }',
    '    ];',
    '    const scripts = [',
    '        { src: "turntable-physics.js?v=20260705-physics-v6", key: "turntable-physics" },',
