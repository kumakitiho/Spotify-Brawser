...
現在の画面には、レコード棚・中央レコード・トーンアーム・プログレス表示の土台があります。次の改善では、見た目を足すだけでなく、**実機っぽいターンテーブルの構造と、円盤が大きく見えるレイアウト** を入れます。
...
- 円盤の占有率を上げるため、タイトル帯・下部ステップ表示・盤面に干渉するスイッチは配置しない
